<template>
  <div x-data="{ sidebarOpen: true }" class="flex overflow-x-hidden h-screen">
    ...
    <aside class="flex-shrink-0 w-64 flex flex-col transition-all duration-300" :class="{ '-ml-64': !sidebarOpen }">
      <div class="overflow-y-auto py-4 px-3 bg-gray-50 rounded-b-lg dark:bg-gray-800">
        <a href="https://flowbite.com" class="flex items-center pl-2.5 mb-5">
          <img
              src="https://w7.pngwing.com/pngs/117/527/png-transparent-letter-blue-alphabet-y-font-alphabet-collection-miscellaneous-blue-logo-thumbnail.png"
        ...
        <ul class="space-y-2">
          <li>
            <a href="#"
               class="flex justify-between items-center p-2 text-base font-normal text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700">
              <div class="flex">
                <svg
    ...
    <div class="flex-1">
      <header class="flex justify-between items-center p-4 text-semibold text-gray-100 dark:bg-gray-800">
        <div>
